...
def Q4a():
    ...
    wall1 = Wall({'position' : [0, 0, 0], 'width' : 5, 'height' : 5, 'orientation' : 0})
    wall2 = Wall({'position' : [0, 0, 0], 'width' : 3, 'height' : 5, 'orientation' : 90})
    wall3 = Wall({'position' : [2.8, 0, 0], 'width' : 5, 'height' : 5, 'orientation' : 0})
    wall4 = Wall({'position' : [-5, 0, 0], 'width' : 2.8, 'height' : 5, 'orientation' : 90})  
